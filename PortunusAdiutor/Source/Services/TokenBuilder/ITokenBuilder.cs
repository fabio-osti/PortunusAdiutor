...
public interface ITokenBuilder
{
	...
	///     Descriptor of the build token.
	/// </param>
	/// 
	/// <returns>
	///     A JWT describing <paramref name="tokenDescriptor" />.
	/// </returns>
	...
	/// 
	/// <param name="claims">
	///     Claims of the build token.
	/// </param>
	/// 
	/// <returns>
	///     A JWT containing <paramref name="claims" />.
	/// </returns>
